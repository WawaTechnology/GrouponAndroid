...
import com.example.unsan.grouponebuy.activities.SpecialSaleLayout;
import com.example.unsan.grouponebuy.adapter.CategoryAdapter;
import com.example.unsan.grouponebuy.adapter.ProductAdapter;
import com.example.unsan.grouponebuy.adapter.ProductDetailViewPagerAdapter;
import com.example.unsan.grouponebuy.adapter.SingleTopAdapter;
import com.example.unsan.grouponebuy.adapter.SpecialCategoryAdapter;
import com.example.unsan.grouponebuy.databinding.ActivityHomeBinding;
...
import com.example.unsan.grouponebuy.utils.ItemOffSetDecoration;
        ...
        */
        ...
        if(imgArray!=null&&imgArray.length>0)
        {
            for (int a = 0; a < imgArray.length; a++) {
                ...
                Glide.with(container.getContext()).load(imgArray[a]).asBitmap().format(PREFER_ARGB_8888).diskCacheStrategy(DiskCacheStrategy.SOURCE).fitCenter().into(imageView);
                listViews.add(pager);
